...
class OperationHistory(models.Model):
    ...
    flow_factor = models.DecimalField('F系数', max_digits=12, decimal_places=5, default=0)
...
def log_history(flow_type, project_name, operator, data, result, flow_factor):
    oh = OperationHistory()
